...
from maeyomi.rendering.palette import audit_palette
from maeyomi.rendering.text import JAPANESE_FONT, font_for
...
def _barcode() -> Finding:
    ...
    with TemporaryDirectory(prefix="maeyomi-doctor-") as directory:
